    ...
    <div className="p-5 sm:p-6 rounded-2xl glass-panel border border-slate-800/80 flex flex-col justify-between gap-4">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-800/80">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="font-bold text-sm text-white tracking-tight">Timeframe Confluence</h3>
            <span className="text-[10px] text-slate-500 font-mono block">
              Multi-Horizon Consensus Matrix
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2.5 py-1">
        {/* Short Term */}
        <div className="p-3 rounded-xl bg-slate-900/60 border border-slate-800/80 flex flex-col items-center text-center gap-1.5">
          <span className="text-[10px] font-mono text-slate-500 uppercase font-semibold">
            Short (5-Day)
          </span>
          <div className="p-2 rounded-lg bg-slate-850">
      ...
      {/* Summary Note */}
      <div className="pt-2 border-t border-slate-800/80 text-[11px] font-mono text-slate-400 text-center">
        <span>Higher confluence indicates stronger directional conviction.</span>
      </div>
    </div>
  );
};
